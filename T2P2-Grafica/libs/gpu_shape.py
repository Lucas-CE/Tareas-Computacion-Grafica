...
#Se crea un objeto que contendra la informacion y forma de una figura
class GPUShape:
    ...
    def fillBuffers(self, vertices, indices, usage):
        ...
        glBufferData(GL_ARRAY_BUFFER, len(vertexData) * SIZE_IN_BYTES,
                     vertexData, usage)

        glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, self.ebo)
        glBufferData(GL_ELEMENT_ARRAY_BUFFER, len(indices) * SIZE_IN_BYTES,
                     indices, usage)
